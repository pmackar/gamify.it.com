...
function LoginContent() {
  ...
  const handleGoogleSignIn = async () => {
    ...
    try {
      ...
      setFormError(
        `Sign in error: ${err instanceof Error ? err.message : "Unknown"}`
      );
    }
    setLoading(false);
  };
        ...
        <div className="bg-gray-900/50 backdrop-blur-xl border border-gray-800 rounded-2xl p-8">
          ...
          {step === "sent" ? (
            ...
            <div className="text-center">
              ...
              <p className="text-gray-400 text-sm mb-4 break-all">{email}</p>
              <p className="text-gray-500 text-sm mb-6 leading-relaxed">
              ...
              {ssoProviders.includes("google") && (
                <button
                  ...
                  disabled={loading}
                  className="w-full px-6 py-4 bg-white hover:bg-gray-100 text-gray-800 font-medium rounded-xl transition-all mb-4 flex items-center justify-center gap-3 disabled:opacity-50"
                >
