...
export function RetroNavBar({ appMenuItems, quickActions, children, theme: themeProp }: RetroNavBarProps = {}) {
  ...
  const [loginMode, setLoginMode] = useState<'google' | 'magic' | 'password'>('google');
                  ...
                  <div className="nav-login-dropdown">
                    {magicLinkSent ? (
                      ...
                      <>
                        ...
                        <div style={{ display: 'flex', marginBottom: '12px', background: 'rgba(0,0,0,0.2)', borderRadius: '6px', padding: '3px' }}>
                          <button
                            ...
                            style={{
                              flex: 1,
                              padding: '6px 8px',
                              background: loginMode === 'google' ? 'rgba(255,215,0,0.2)' : 'transparent',
                              border: 'none',
                              borderRadius: '4px',
                              color: loginMode === 'google' ? '#FFD700' : '#666',
                        ...
                        {loginMode === 'google' ? (
                          <>
                            <p className="nav-login-title">QUICK SIGN IN</p>
                            <button
                            ...
                            <p style={{ fontSize: '7px', color: '#555', marginTop: '12px', textAlign: 'center', fontFamily: "'Press Start 2P', monospace" }}>One click sign in!</p>
                          </>
                        ) : loginMode === 'magic' ? (
                          <>
